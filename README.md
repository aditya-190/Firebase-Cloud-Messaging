<h1 align="center">Firebase-Cloud-Messaging</h1>

## 🖥 Objective:
- To gain knowledge on Android Notification with and without firebase Cloud Messaging.
- To prepare a template for future projects.
- To explore all the methods on Notifications.
- To know how to make a custom Notification.
